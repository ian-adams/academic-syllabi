...
officehours: "With TA, Tue. 1-3pm, Currell 'Roost'"
#office: "Currell 114"
classroom: "Carolina Coliseum, 3001"
classhours: "T/Th, 11:40a to 12:55p"
...
not_here_dates <- c(
  # Fall Break
  seq(ymd(20231019),ymd(20231020), by=1),
  # Eurocrim
  #seq(ymd(20230901),ymd(20230911), by=1),
  # Thanksgiving
  seq(ymd(20231122),ymd(20231126), by=1))
  # ASC 2023
  #seq(ymd(20231115),ymd(20231117), by=1))
...
Cal %>% 
  ...
  labs(fill = "", x="", y="",
       caption = "Notable dates: EuroCrim Sept. 1-11; Fall Break (no class) Oct. 19-20; Thanksgiving Break (no class) Nov. 22-26; Finals week (no class) Dec. 11-15")  -> class_cal
...
Tuesday/Thursday | 11:40a to 12:55p | Carolina Coliseum | Room 3001
...
"Traditional" office hours are with our TA, set for Tuesdays from 1-3pm (directly after class). These are drop-in hours and highly recommended. Just go to "The Roost" - which is where the graduate students are in Currell (first floor, right by the administrative offices). 

I'm also happy to set up alternative meetings if necessary. Email the TA and myself with a request and some suggested meeting times, and we can usually work something out.
...
-  You **MUST** access Packback assignments through Blackboard. If you do not (for example by logging into Packback directly) you will **not receive credit for your work.**
-  Open-ended question every week with a minimum Curiosity Score of 70, worth 2 points of each assignment grade
-  Responses every week with a minimum Curiosity Score of 70, worth 4 points of each assignment grade
...
There are **no late Packback assignments are allowed**. The point of a discussion is to interact with the class - if you try to "go back" to a previous discussion, you will be talking to an empty room. I highly recommend you not leave these assignments until the last minute!
...
-  In order for your grade to be visible in Blackboard, make sure to click each Packback assignment link as you post your Packback submissions. *Do not go to the Packback website with a bookmark - always go through Blackboard!*
...
The final exam has electronic proctoring enabled to ensure ethical test taking. My strong suggestion is to use campus computing resources for all exams, including the final.
...
**YOU MUST EMAIL THE TA AND PROFESSOR ADAMS WITH REQUESTS**. The only exception for this rule is if you are reaching out because of issues related to sensitive and/or protected information. Failure to "cc" either Professor Adams or the TA will result in delays in a response, or even no response.
...
grades <- read_csv(here("CRJU 314", "Spring 2023", "grading-scheme.csv"))
